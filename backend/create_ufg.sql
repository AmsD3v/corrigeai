-- UFG (Universidade Federal de Goiás) - Conquistas e 20 Lições
-- Execute: docker exec -it prosaai_db psql -U user -d prosaai -f /tmp/ufg.sql
...
-- Redações UFG
('ufg_essays_1', 'Primeira Redação UFG', 'Enviou sua primeira redação UFG', '📝', 'ufg', 'essays_count', 1, 25, 0),
('ufg_essays_5', 'Escritor UFG', 'Enviou 5 redações UFG', '✍️', 'ufg', 'essays_count', 5, 50, 1),
('ufg_essays_10', 'Redator Dedicado UFG', 'Enviou 10 redações UFG', '📚', 'ufg', 'essays_count', 10, 100, 2),

-- Notas UFG (0-100)
('ufg_bronze', 'Nota Bronze UFG', 'Atingiu 60+ na UFG', '🥉', 'ufg', 'score', 60, 100, 2),
('ufg_prata', 'Nota Prata UFG', 'Atingiu 80+ na UFG', '🥈', 'ufg', 'score', 80, 200, 5),
('ufg_ouro', 'Nota Ouro UFG', 'Atingiu 90+ na UFG', '🥇', 'ufg', 'score', 90, 300, 10),

-- Lições UFG
('ufg_lessons_5', 'Iniciante UFG', 'Completou 5 lições da UFG', '📖', 'ufg', 'lessons', 5, 50, 1),
('ufg_lessons_15', 'Estudante UFG', 'Completou 15 lições da UFG', '📚', 'ufg', 'lessons', 15, 150, 3),
('ufg_lessons_20', 'Mestre UFG', 'Completou todas as 20 lições UFG', '🎓', 'ufg', 'lessons', 20, 300, 5);

-- ============================================================================
-- LIÇÕES UFG - 20 (5 por critério)
...
('ufg', 1, 1, 'A Redação UFG', 'Conhecendo o vestibular', 
'# A Redação da UFG
...
## Contexto Regional
A UFG pode abordar temas do Cerrado e Centro-Oeste.',
'[{"question": "A UFG está localizada em:", "options": ["Brasília", "Goiânia", "Cuiabá"], "correct": 1}]',
30, 'free', 0),

('ufg', 1, 2, 'Interpretando o Tema', 'Compreensão correta', 
'# Análise do Tema
...
('ufg', 1, 3, 'Tese Clara', 'Posicionamento objetivo', 
'# Construindo a Tese
...
✅ "O agronegócio brasileiro precisa conciliar produtividade e preservação ambiental para garantir desenvolvimento sustentável"',
'[{"question": "A tese deve ser:", "options": ["Vaga", "Clara e defensável"], "correct": 1}]',
40, 'previous', 0),

('ufg', 1, 4, 'Temas Regionais', 'Contexto goiano', 
'# Temas de Goiás/Centro-Oeste
...
'[{"question": "Cora Coralina era:", "options": ["Cantora", "Poetisa goiana"], "correct": 1}]',
45, 'previous', 0),

('ufg', 1, 5, 'Repertório Sociocultural', 'Fontes para argumentar', 
'# Repertório para UFG
...
- Chapadas e veredas',
'[{"question": "O Cerrado é chamado de:", "options": ["Pulmão", "Caixa d''água do Brasil"], "correct": 1}]',
50, 'previous', 0);

-- CRITÉRIO 2: ESTRUTURA TEXTUAL (5 lições)
INSERT INTO lesson (exam_type, competency, "order", title, description, content, quiz_data, xp_reward, unlock_type, unlock_value) VALUES
('ufg', 2, 1, 'Estrutura Dissertativa', 'Organizando o texto', 
...
('ufg', 2, 2, 'Introdução Eficaz', 'Abrindo o texto', 
'# A Introdução
...
('ufg', 2, 3, 'Parágrafos de Desenvolvimento', 'Argumentando', 
'# Desenvolvimento
...
('ufg', 2, 4, 'Conectivos', 'Ligando ideias', 
...
('ufg', 2, 5, 'Conclusão', 'Fechando o texto', 
'# A Conclusão
...
INSERT INTO lesson (exam_type, competency, "order", title, description, content, quiz_data, xp_reward, unlock_type, unlock_value) VALUES
('ufg', 3, 1, 'Tipos de Argumento', 'Construindo defesas', 
'# Argumentação
...
('ufg', 3, 2, 'Análise Crítica', 'Aprofundando', 
'# Análise Crítica
...
('ufg', 3, 3, 'Coerência Argumentativa', 'Lógica do texto', 
'# Coerência
...
('ufg', 3, 4, 'Progressão', 'Avançando ideias', 
...
('ufg', 3, 5, 'Repertório', 'Usando referências', 
'# Repertório
...
INSERT INTO lesson (exam_type, competency, "order", title, description, content, quiz_data, xp_reward, unlock_type, unlock_value) VALUES
('ufg', 4, 1, 'Norma Culta', 'Gramática essencial', 
'# Norma Culta
...
('ufg', 4, 2, 'Concordância', 'Verbal e nominal', 
'# Concordância
...
'[{"question": "''Existem problemas'' é:", "options": ["Incorreto", "Correto"], "correct": 1}]',
35, 'previous', 0),

('ufg', 4, 3, 'Regência e Crase', 'Preposições corretas', 
'# Regência
...
'[{"question": "''Ir à escola'' tem crase?", "options": ["Não", "Sim"], "correct": 1}]',
40, 'previous', 0),

('ufg', 4, 4, 'Pontuação', 'Vírgulas e mais', 
'# Pontuação
...
('ufg', 4, 5, 'Revisão Final', 'Checklist', 
'# Checklist UFG
...
SELECT 'UFG: Criadas conquistas e ' || COUNT(*) || ' lições!' as status FROM lesson WHERE exam_type = 'ufg';
