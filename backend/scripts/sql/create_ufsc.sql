-- UFSC (Universidade Federal de Santa Catarina) - Conquistas e 20 Lições
-- Execute: docker exec -it prosaai_db psql -U user -d prosaai -f /tmp/ufsc.sql
...
-- Redações UFSC
('ufsc_essays_1', 'Primeira Redação UFSC', 'Enviou sua primeira redação UFSC', '📝', 'ufsc', 'essays_count', 1, 25, 0),
('ufsc_essays_5', 'Escritor UFSC', 'Enviou 5 redações UFSC', '✍️', 'ufsc', 'essays_count', 5, 50, 1),
('ufsc_essays_10', 'Redator Dedicado UFSC', 'Enviou 10 redações UFSC', '📚', 'ufsc', 'essays_count', 10, 100, 2),

-- Notas UFSC (0-10)
('ufsc_bronze', 'Nota Bronze UFSC', 'Atingiu 6+ na UFSC', '🥉', 'ufsc', 'score', 6, 100, 2),
('ufsc_prata', 'Nota Prata UFSC', 'Atingiu 8+ na UFSC', '🥈', 'ufsc', 'score', 8, 200, 5),
('ufsc_ouro', 'Nota Ouro UFSC', 'Atingiu 9+ na UFSC', '🥇', 'ufsc', 'score', 9, 300, 10),

-- Lições UFSC
('ufsc_lessons_5', 'Iniciante UFSC', 'Completou 5 lições da UFSC', '📖', 'ufsc', 'lessons', 5, 50, 1),
('ufsc_lessons_15', 'Estudante UFSC', 'Completou 15 lições da UFSC', '📚', 'ufsc', 'lessons', 15, 150, 3),
('ufsc_lessons_20', 'Mestre UFSC', 'Completou todas as 20 lições UFSC', '🎓', 'ufsc', 'lessons', 20, 300, 5);

-- ============================================================================
-- LIÇÕES UFSC - 20 (5 por critério)
...
('ufsc', 1, 1, 'A Redação UFSC', 'Conhecendo o vestibular', 
'# A Redação da UFSC
...
## Diferencial
UFSC: excelência em pesquisa e inovação.',
'[{"question": "A UFSC está localizada em:", "options": ["Curitiba", "Florianópolis", "Porto Alegre"], "correct": 1}]',
30, 'free', 0),

('ufsc', 1, 2, 'Interpretando o Tema', 'Compreensão correta', 
'# Análise do Tema
...
('ufsc', 1, 3, 'Tese Clara', 'Posicionamento objetivo', 
'# Construindo a Tese
...
✅ "O turismo sustentável na Ilha de Santa Catarina demanda políticas que conciliem desenvolvimento econômico e preservação dos ecossistemas costeiros"',
'[{"question": "A tese deve ser:", "options": ["Vaga", "Clara e defensável"], "correct": 1}]',
40, 'previous', 0),

('ufsc', 1, 4, 'Temas Regionais', 'Contexto catarinense', 
'# Temas de Santa Catarina
...
- Baleias-francas',
'[{"question": "Cruz e Sousa era:", "options": ["Pintor", "Poeta catarinense"], "correct": 1}]',
45, 'previous', 0),

('ufsc', 1, 5, 'Repertório Sociocultural', 'Fontes para argumentar', 
'# Repertório para UFSC
...
- Harry Laus
- Lindolf Bell
- Franklin Cascaes (folclore)',
'[{"question": "Franklin Cascaes estudou:", "options": ["Economia", "Folclore açoriano"], "correct": 1}]',
50, 'previous', 0);

-- CRITÉRIO 2: ESTRUTURA E COESÃO (5 lições)
INSERT INTO lesson (exam_type, competency, "order", title, description, content, quiz_data, xp_reward, unlock_type, unlock_value) VALUES
('ufsc', 2, 1, 'Estrutura Dissertativa', 'Organizando o texto', 
...
('ufsc', 2, 2, 'Introdução Eficaz', 'Abrindo o texto', 
'# A Introdução
...
('ufsc', 2, 3, 'Coesão Textual', 'Conectando ideias', 
'# Coesão
...
('ufsc', 2, 4, 'Transições', 'Entre parágrafos', 
'# Transições Fluidas
...
('ufsc', 2, 5, 'Conclusão', 'Fechando o texto', 
'# A Conclusão
...
INSERT INTO lesson (exam_type, competency, "order", title, description, content, quiz_data, xp_reward, unlock_type, unlock_value) VALUES
('ufsc', 3, 1, 'Tipos de Argumento', 'Construindo defesas', 
'# Argumentação
...
('ufsc', 3, 2, 'Análise Crítica', 'Aprofundando', 
'# Análise Crítica
...
('ufsc', 3, 3, 'Coerência Argumentativa', 'Lógica do texto', 
'# Coerência
...
('ufsc', 3, 4, 'Progressão', 'Avançando ideias', 
...
('ufsc', 3, 5, 'Repertório', 'Usando referências', 
'# Repertório
...
INSERT INTO lesson (exam_type, competency, "order", title, description, content, quiz_data, xp_reward, unlock_type, unlock_value) VALUES
('ufsc', 4, 1, 'Norma Culta', 'Gramática essencial', 
'# Norma Culta
...
('ufsc', 4, 2, 'Concordância', 'Verbal e nominal', 
'# Concordância
...
'[{"question": "''Houve festivais'' é:", "options": ["Incorreto", "Correto"], "correct": 1}]',
35, 'previous', 0),

('ufsc', 4, 3, 'Regência e Crase', 'Preposições corretas', 
'# Regência
...
'[{"question": "''Ir à Florianópolis'' tem crase?", "options": ["Sim (artigo)", "Não"], "correct": 0}]',
40, 'previous', 0),

('ufsc', 4, 4, 'Pontuação', 'Vírgulas e mais', 
'# Pontuação
...
('ufsc', 4, 5, 'Revisão Final', 'Checklist', 
'# Checklist UFSC
...
SELECT 'UFSC: Criadas conquistas e ' || COUNT(*) || ' lições!' as status FROM lesson WHERE exam_type = 'ufsc';
