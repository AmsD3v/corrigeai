-- UFES (Universidade Federal do Espírito Santo) - Conquistas e 20 Lições
-- Execute: docker exec -it prosaai_db psql -U user -d prosaai -f /tmp/ufes.sql
...
-- Redações UFES
('ufes_essays_1', 'Primeira Redação UFES', 'Enviou sua primeira redação UFES', '📝', 'ufes', 'essays_count', 1, 25, 0),
('ufes_essays_5', 'Escritor UFES', 'Enviou 5 redações UFES', '✍️', 'ufes', 'essays_count', 5, 50, 1),
('ufes_essays_10', 'Redator Dedicado UFES', 'Enviou 10 redações UFES', '📚', 'ufes', 'essays_count', 10, 100, 2),

-- Notas UFES (0-100)
('ufes_bronze', 'Nota Bronze UFES', 'Atingiu 60+ na UFES', '🥉', 'ufes', 'score', 60, 100, 2),
('ufes_prata', 'Nota Prata UFES', 'Atingiu 80+ na UFES', '🥈', 'ufes', 'score', 80, 200, 5),
('ufes_ouro', 'Nota Ouro UFES', 'Atingiu 90+ na UFES', '🥇', 'ufes', 'score', 90, 300, 10),

-- Lições UFES
('ufes_lessons_5', 'Iniciante UFES', 'Completou 5 lições da UFES', '📖', 'ufes', 'lessons', 5, 50, 1),
('ufes_lessons_15', 'Estudante UFES', 'Completou 15 lições da UFES', '📚', 'ufes', 'lessons', 15, 150, 3),
('ufes_lessons_20', 'Mestre UFES', 'Completou todas as 20 lições UFES', '🎓', 'ufes', 'lessons', 20, 300, 5);

-- ============================================================================
-- LIÇÕES UFES - 20 (5 por critério)
...
('ufes', 1, 1, 'A Redação UFES', 'Conhecendo o vestibular', 
'# A Redação da UFES
...
## Contexto Regional
A UFES pode abordar temas do Espírito Santo e região Sudeste.',
'[{"question": "A UFES está localizada em:", "options": ["Belo Horizonte", "Vitória", "Rio de Janeiro"], "correct": 1}]',
30, 'free', 0),

('ufes', 1, 2, 'Interpretando o Tema', 'Compreensão correta', 
'# Análise do Tema
...
('ufes', 1, 3, 'Tese Clara', 'Posicionamento objetivo', 
'# Construindo a Tese
...
✅ "O turismo sustentável no litoral capixaba demanda equilíbrio entre desenvolvimento econômico e preservação ambiental"',
'[{"question": "A tese deve ser:", "options": ["Vaga", "Clara e defensável"], "correct": 1}]',
40, 'previous', 0),

('ufes', 1, 4, 'Temas Regionais', 'Contexto capixaba', 
...
- Convento da Penha
- Imigração europeia',
'[{"question": "Rubem Braga era:", "options": ["Pintor", "Cronista/escritor"], "correct": 1}]',
45, 'previous', 0),

('ufes', 1, 5, 'Repertório Sociocultural', 'Fontes para argumentar', 
'# Repertório para UFES
...
- Moqueca capixaba',
'[{"question": "Paneleiras de Goiabeiras são:", "options": ["Pescadoras", "Artesãs de barro"], "correct": 1}]',
50, 'previous', 0);

-- CRITÉRIO 2: ESTRUTURA E COESÃO (5 lições)
INSERT INTO lesson (exam_type, competency, "order", title, description, content, quiz_data, xp_reward, unlock_type, unlock_value) VALUES
('ufes', 2, 1, 'Estrutura Dissertativa', 'Organizando o texto', 
...
('ufes', 2, 2, 'Introdução Eficaz', 'Abrindo o texto', 
'# A Introdução
...
('ufes', 2, 3, 'Coesão Textual', 'Conectando ideias', 
'# Coesão
...
'[{"question": "''Entretanto'' indica:", "options": ["Adição", "Oposição"], "correct": 1}]',
40, 'previous', 0),

('ufes', 2, 4, 'Transições', 'Entre parágrafos', 
'# Transições Fluidas
...
**Início D2:** "Além dessa questão, o aspecto..."',
'[{"question": "Transições conectam:", "options": ["Apenas frases", "Parágrafos"], "correct": 1}]',
45, 'previous', 0),

('ufes', 2, 5, 'Conclusão', 'Fechando o texto', 
'# A Conclusão
...
INSERT INTO lesson (exam_type, competency, "order", title, description, content, quiz_data, xp_reward, unlock_type, unlock_value) VALUES
('ufes', 3, 1, 'Tipos de Argumento', 'Construindo defesas', 
'# Argumentação
...
('ufes', 3, 2, 'Análise Crítica', 'Aprofundando', 
'# Análise Crítica
...
('ufes', 3, 3, 'Coerência Argumentativa', 'Lógica do texto', 
'# Coerência
...
('ufes', 3, 4, 'Progressão', 'Avançando ideias', 
...
('ufes', 3, 5, 'Repertório', 'Usando referências', 
'# Repertório
...
INSERT INTO lesson (exam_type, competency, "order", title, description, content, quiz_data, xp_reward, unlock_type, unlock_value) VALUES
('ufes', 4, 1, 'Norma Culta', 'Gramática essencial', 
'# Norma Culta
...
('ufes', 4, 2, 'Concordância', 'Verbal e nominal', 
'# Concordância
...
('ufes', 4, 3, 'Regência e Crase', 'Preposições corretas', 
'# Regência
...
'[{"question": "''Implicar em algo'' é:", "options": ["Correto", "Incorreto (implicar algo)"], "correct": 1}]',
40, 'previous', 0),

('ufes', 4, 4, 'Pontuação', 'Vírgulas e mais', 
'# Pontuação
...
('ufes', 4, 5, 'Revisão Final', 'Checklist', 
'# Checklist UFES
...
SELECT 'UFES: Criadas conquistas e ' || COUNT(*) || ' lições!' as status FROM lesson WHERE exam_type = 'ufes';
