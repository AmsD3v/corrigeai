-- UERR (Universidade Estadual de Roraima) - Conquistas e 20 Lições
-- Execute: docker exec -it prosaai_db psql -U user -d prosaai -f /tmp/uerr.sql
...
-- Redações UERR
('uerr_essays_1', 'Primeira Redação UERR', 'Enviou sua primeira redação UERR', '📝', 'uerr', 'essays_count', 1, 25, 0),
('uerr_essays_5', 'Escritor UERR', 'Enviou 5 redações UERR', '✍️', 'uerr', 'essays_count', 5, 50, 1),
('uerr_essays_10', 'Redator Dedicado UERR', 'Enviou 10 redações UERR', '📚', 'uerr', 'essays_count', 10, 100, 2),

-- Notas UERR (0-100)
('uerr_bronze', 'Nota Bronze UERR', 'Atingiu 60+ na UERR', '🥉', 'uerr', 'score', 60, 100, 2),
('uerr_prata', 'Nota Prata UERR', 'Atingiu 80+ na UERR', '🥈', 'uerr', 'score', 80, 200, 5),
('uerr_ouro', 'Nota Ouro UERR', 'Atingiu 90+ na UERR', '🥇', 'uerr', 'score', 90, 300, 10),

-- Lições UERR
('uerr_lessons_5', 'Iniciante UERR', 'Completou 5 lições da UERR', '📖', 'uerr', 'lessons', 5, 50, 1),
('uerr_lessons_15', 'Estudante UERR', 'Completou 15 lições da UERR', '📚', 'uerr', 'lessons', 15, 150, 3),
('uerr_lessons_20', 'Mestre UERR', 'Completou todas as 20 lições UERR', '🎓', 'uerr', 'lessons', 20, 300, 5);

-- ============================================================================
-- LIÇÕES UERR - 20 (5 por critério)
...
('uerr', 1, 1, 'A Redação UERR', 'Conhecendo o vestibular', 
'# A Redação da UERR
...
## Contexto Regional
Roraima: extremo norte, fronteiras internacionais.',
'[{"question": "A UERR está localizada em:", "options": ["Manaus", "Boa Vista", "Macapá"], "correct": 1}]',
30, 'free', 0),

('uerr', 1, 2, 'Interpretando o Tema', 'Compreensão correta', 
'# Análise do Tema
...
('uerr', 1, 3, 'Tese Clara', 'Posicionamento objetivo', 
'# Construindo a Tese
...
✅ "O desenvolvimento de Roraima demanda políticas de integração com Venezuela e Guiana que valorizem a soberania nacional"',
'[{"question": "A tese deve ser:", "options": ["Vaga", "Clara e defensável"], "correct": 1}]',
40, 'previous', 0),

('uerr', 1, 4, 'Temas Regionais', 'Contexto roraimense', 
'# Temas de Roraima
...
- Crise venezuelana
- Lavrado roraimense',
'[{"question": "O Monte Roraima é:", "options": ["Vulcão", "Marco tríplice Brasil-Venezuela-Guiana"], "correct": 1}]',
45, 'previous', 0),

('uerr', 1, 5, 'Repertório Sociocultural', 'Fontes para argumentar', 
'# Repertório para UERR
...
- Monte Roraima (tepui)
- Fronteira norte',
'[{"question": "Os Yanomami são:", "options": ["Cidade", "Povo indígena"], "correct": 1}]',
50, 'previous', 0);

-- CRITÉRIO 2: ESTRUTURA TEXTUAL (5 lições)
INSERT INTO lesson (exam_type, competency, "order", title, description, content, quiz_data, xp_reward, unlock_type, unlock_value) VALUES
('uerr', 2, 1, 'Estrutura Dissertativa', 'Organizando o texto', 
...
('uerr', 2, 2, 'Introdução Eficaz', 'Abrindo o texto', 
'# A Introdução
...
('uerr', 2, 3, 'Parágrafos de Desenvolvimento', 'Argumentando', 
'# Desenvolvimento
...
('uerr', 2, 4, 'Conectivos', 'Ligando ideias', 
...
('uerr', 2, 5, 'Conclusão', 'Fechando o texto', 
'# A Conclusão
...
INSERT INTO lesson (exam_type, competency, "order", title, description, content, quiz_data, xp_reward, unlock_type, unlock_value) VALUES
('uerr', 3, 1, 'Tipos de Argumento', 'Construindo defesas', 
'# Argumentação
...
('uerr', 3, 2, 'Análise Crítica', 'Aprofundando', 
'# Análise Crítica
...
('uerr', 3, 3, 'Coerência Argumentativa', 'Lógica do texto', 
'# Coerência
...
('uerr', 3, 4, 'Progressão', 'Avançando ideias', 
...
('uerr', 3, 5, 'Repertório', 'Usando referências', 
'# Repertório
...
INSERT INTO lesson (exam_type, competency, "order", title, description, content, quiz_data, xp_reward, unlock_type, unlock_value) VALUES
('uerr', 4, 1, 'Norma Culta', 'Gramática essencial', 
'# Norma Culta
...
('uerr', 4, 2, 'Concordância', 'Verbal e nominal', 
'# Concordância
...
'[{"question": "''Houve conflitos'' é:", "options": ["Incorreto", "Correto"], "correct": 1}]',
35, 'previous', 0),

('uerr', 4, 3, 'Regência e Crase', 'Preposições corretas', 
'# Regência
...
('uerr', 4, 4, 'Pontuação', 'Vírgulas e mais', 
'# Pontuação
...
('uerr', 4, 5, 'Revisão Final', 'Checklist', 
'# Checklist UERR
...
SELECT 'UERR: Criadas conquistas e ' || COUNT(*) || ' lições!' as status FROM lesson WHERE exam_type = 'uerr';
