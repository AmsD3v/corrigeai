-- UFPE (Universidade Federal de Pernambuco) - Conquistas e 20 Lições
-- Execute: docker exec -it prosaai_db psql -U user -d prosaai -f /tmp/ufpe.sql
...
-- Redações UFPE
('ufpe_essays_1', 'Primeira Redação UFPE', 'Enviou sua primeira redação UFPE', '📝', 'ufpe', 'essays_count', 1, 25, 0),
('ufpe_essays_5', 'Escritor UFPE', 'Enviou 5 redações UFPE', '✍️', 'ufpe', 'essays_count', 5, 50, 1),
('ufpe_essays_10', 'Redator Dedicado UFPE', 'Enviou 10 redações UFPE', '📚', 'ufpe', 'essays_count', 10, 100, 2),

-- Notas UFPE (0-100)
('ufpe_bronze', 'Nota Bronze UFPE', 'Atingiu 60+ na UFPE', '🥉', 'ufpe', 'score', 60, 100, 2),
('ufpe_prata', 'Nota Prata UFPE', 'Atingiu 80+ na UFPE', '🥈', 'ufpe', 'score', 80, 200, 5),
('ufpe_ouro', 'Nota Ouro UFPE', 'Atingiu 90+ na UFPE', '🥇', 'ufpe', 'score', 90, 300, 10),

-- Lições UFPE
('ufpe_lessons_5', 'Iniciante UFPE', 'Completou 5 lições da UFPE', '📖', 'ufpe', 'lessons', 5, 50, 1),
('ufpe_lessons_15', 'Estudante UFPE', 'Completou 15 lições da UFPE', '📚', 'ufpe', 'lessons', 15, 150, 3),
('ufpe_lessons_20', 'Mestre UFPE', 'Completou todas as 20 lições UFPE', '🎓', 'ufpe', 'lessons', 20, 300, 5);

-- ============================================================================
-- LIÇÕES UFPE - 20 (5 por critério)
...
('ufpe', 1, 1, 'A Redação UFPE', 'Conhecendo o vestibular', 
'# A Redação da UFPE
...
## Contexto Regional
A UFPE valoriza a cultura pernambucana e nordestina.',
'[{"question": "A UFPE fica em:", "options": ["Salvador", "Recife"], "correct": 1}]',
30, 'free', 0),

('ufpe', 1, 2, 'Interpretando o Tema', 'Compreensão correta', 
'# Análise do Tema
...
('ufpe', 1, 3, 'Tese Clara', 'Posicionamento objetivo', 
'# Construindo a Tese
...
('ufpe', 1, 4, 'Temas Regionais', 'Contexto pernambucano', 
'# Temas de Pernambuco
...
('ufpe', 1, 5, 'Repertório Sociocultural', 'Fontes para argumentar', 
'# Repertório para UFPE
...
INSERT INTO lesson (exam_type, competency, "order", title, description, content, quiz_data, xp_reward, unlock_type, unlock_value) VALUES
('ufpe', 2, 1, 'Estrutura Dissertativa', 'Organizando o texto', 
...
('ufpe', 2, 2, 'Introdução Eficaz', 'Abrindo o texto', 
'# A Introdução
...
('ufpe', 2, 3, 'Coesão Textual', 'Conectando ideias', 
'# Coesão
...
('ufpe', 2, 4, 'Transições', 'Entre parágrafos', 
'# Transições Fluidas
...
('ufpe', 2, 5, 'Conclusão', 'Fechando o texto', 
'# A Conclusão
...
INSERT INTO lesson (exam_type, competency, "order", title, description, content, quiz_data, xp_reward, unlock_type, unlock_value) VALUES
('ufpe', 3, 1, 'Tipos de Argumento', 'Construindo defesas', 
'# Argumentação
...
('ufpe', 3, 2, 'Análise Crítica', 'Aprofundando', 
'# Análise Crítica
...
('ufpe', 3, 3, 'Coerência Argumentativa', 'Lógica do texto', 
'# Coerência
...
('ufpe', 3, 4, 'Progressão', 'Avançando ideias', 
...
('ufpe', 3, 5, 'Repertório Pernambucano', 'Referências regionais', 
'# Repertório para UFPE
...
INSERT INTO lesson (exam_type, competency, "order", title, description, content, quiz_data, xp_reward, unlock_type, unlock_value) VALUES
('ufpe', 4, 1, 'Norma Culta', 'Gramática essencial', 
'# Norma Culta
...
('ufpe', 4, 2, 'Concordância', 'Verbal e nominal', 
'# Concordância
...
('ufpe', 4, 3, 'Regência e Crase', 'Preposições corretas', 
'# Regência
...
('ufpe', 4, 4, 'Pontuação', 'Vírgulas e mais', 
'# Pontuação
...
('ufpe', 4, 5, 'Revisão Final', 'Checklist', 
'# Checklist UFPE
...
SELECT 'UFPE: Criadas conquistas e ' || COUNT(*) || ' lições!' as status FROM lesson WHERE exam_type = 'ufpe';
