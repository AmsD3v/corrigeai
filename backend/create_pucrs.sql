-- PUCRS (Pontifícia Universidade Católica do Rio Grande do Sul) - Conquistas e 20 Lições
-- Execute: docker exec -it prosaai_db psql -U user -d prosaai -f /tmp/pucrs.sql
...
-- Redações PUCRS
('pucrs_essays_1', 'Primeira Redação PUCRS', 'Enviou sua primeira redação PUCRS', '📝', 'pucrs', 'essays_count', 1, 25, 0),
('pucrs_essays_5', 'Escritor PUCRS', 'Enviou 5 redações PUCRS', '✍️', 'pucrs', 'essays_count', 5, 50, 1),
('pucrs_essays_10', 'Redator Dedicado PUCRS', 'Enviou 10 redações PUCRS', '📚', 'pucrs', 'essays_count', 10, 100, 2),

-- Notas PUCRS (0-100)
('pucrs_bronze', 'Nota Bronze PUCRS', 'Atingiu 60+ na PUCRS', '🥉', 'pucrs', 'score', 60, 100, 2),
('pucrs_prata', 'Nota Prata PUCRS', 'Atingiu 80+ na PUCRS', '🥈', 'pucrs', 'score', 80, 200, 5),
('pucrs_ouro', 'Nota Ouro PUCRS', 'Atingiu 90+ na PUCRS', '🥇', 'pucrs', 'score', 90, 300, 10),

-- Lições PUCRS
('pucrs_lessons_5', 'Iniciante PUCRS', 'Completou 5 lições da PUCRS', '📖', 'pucrs', 'lessons', 5, 50, 1),
('pucrs_lessons_15', 'Estudante PUCRS', 'Completou 15 lições da PUCRS', '📚', 'pucrs', 'lessons', 15, 150, 3),
('pucrs_lessons_20', 'Mestre PUCRS', 'Completou todas as 20 lições PUCRS', '🎓', 'pucrs', 'lessons', 20, 300, 5);

-- ============================================================================
-- LIÇÕES PUCRS - 20 (5 por critério)
...
('pucrs', 1, 1, 'A Redação PUCRS', 'Conhecendo o vestibular', 
'# A Redação da PUCRS
...
## Diferencial
Tradição gaúcha e excelência acadêmica.',
'[{"question": "A PUCRS fica em:", "options": ["Curitiba", "Porto Alegre"], "correct": 1}]',
30, 'free', 0),

('pucrs', 1, 2, 'Interpretando o Tema', 'Compreensão correta', 
'# Análise do Tema
...
('pucrs', 1, 3, 'Tese Clara', 'Posicionamento objetivo', 
'# Construindo a Tese
...
✅ "A preservação da identidade cultural gaúcha demanda políticas que valorizem tradições enquanto dialogam com a contemporaneidade"',
'[{"question": "A tese deve ser:", "options": ["Vaga", "Clara e defensável"], "correct": 1}]',
40, 'previous', 0),

('pucrs', 1, 4, 'Temas Gaúchos', 'Contexto PUCRS', 
'# Temas da PUCRS
...
('pucrs', 1, 5, 'Repertório Sociocultural', 'Fontes para argumentar', 
'# Repertório para PUCRS
...
- Simões Lopes Neto
- Caio Fernando Abreu',
'[{"question": "Erico Verissimo escreveu:", "options": ["Grande Sertão", "O Tempo e o Vento"], "correct": 1}]',
50, 'previous', 0);

-- CRITÉRIO 2: ESTRUTURA TEXTUAL (5 lições)
INSERT INTO lesson (exam_type, competency, "order", title, description, content, quiz_data, xp_reward, unlock_type, unlock_value) VALUES
('pucrs', 2, 1, 'Estrutura Dissertativa', 'Organizando o texto', 
...
('pucrs', 2, 2, 'Introdução Eficaz', 'Abrindo o texto', 
'# A Introdução
...
('pucrs', 2, 3, 'Parágrafos de Desenvolvimento', 'Argumentando', 
'# Desenvolvimento
...
('pucrs', 2, 4, 'Conectivos', 'Ligando ideias', 
...
('pucrs', 2, 5, 'Conclusão', 'Fechando o texto', 
'# A Conclusão
...
INSERT INTO lesson (exam_type, competency, "order", title, description, content, quiz_data, xp_reward, unlock_type, unlock_value) VALUES
('pucrs', 3, 1, 'Tipos de Argumento', 'Construindo defesas', 
'# Argumentação
...
## Estratégia
Use repertório cultural gaúcho.',
'[{"question": "Quantos tipos usar:", "options": ["1", "2 ou mais"], "correct": 1}]',
30, 'free', 0),

('pucrs', 3, 2, 'Análise Crítica', 'Aprofundando', 
'# Análise Crítica
...
('pucrs', 3, 3, 'Coerência Argumentativa', 'Lógica do texto', 
'# Coerência
...
('pucrs', 3, 4, 'Progressão', 'Avançando ideias', 
...
('pucrs', 3, 5, 'Repertório', 'Usando referências', 
'# Repertório
...
INSERT INTO lesson (exam_type, competency, "order", title, description, content, quiz_data, xp_reward, unlock_type, unlock_value) VALUES
('pucrs', 4, 1, 'Norma Culta', 'Gramática essencial', 
'# Norma Culta
...
('pucrs', 4, 2, 'Concordância', 'Verbal e nominal', 
'# Concordância
...
('pucrs', 4, 3, 'Regência e Crase', 'Preposições corretas', 
'# Regência
...
'[{"question": "''Ir à Serra Gaúcha'' tem crase?", "options": ["Não", "Sim (região feminina)"], "correct": 1}]',
40, 'previous', 0),

('pucrs', 4, 4, 'Pontuação', 'Vírgulas e mais', 
'# Pontuação
...
('pucrs', 4, 5, 'Revisão Final', 'Checklist', 
'# Checklist PUCRS
...
SELECT 'PUCRS: Criadas conquistas e ' || COUNT(*) || ' lições!' as status FROM lesson WHERE exam_type = 'pucrs';
