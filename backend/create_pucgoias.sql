-- PUC-Goiás (Pontifícia Universidade Católica de Goiás) - Conquistas e 20 Lições
-- Execute: docker exec -it prosaai_db psql -U user -d prosaai -f /tmp/pucgoias.sql

-- ============================================================================
-- CONQUISTAS PUC-Goiás
-- ============================================================================

INSERT INTO achievement (code, name, description, icon, exam_type, condition_type, condition_value, xp_reward, coin_reward) VALUES
-- Redações PUC-Goiás
('pucgoias_essays_1', 'Primeira Redação PUC-Goiás', 'Enviou sua primeira redação PUC-Goiás', '📝', 'pucgoias', 'essays_count', 1, 25, 0),
('pucgoias_essays_5', 'Escritor PUC-Goiás', 'Enviou 5 redações PUC-Goiás', '✍️', 'pucgoias', 'essays_count', 5, 50, 1),
('pucgoias_essays_10', 'Redator Dedicado PUC-Goiás', 'Enviou 10 redações PUC-Goiás', '📚', 'pucgoias', 'essays_count', 10, 100, 2),

-- Notas PUC-Goiás (0-100)
('pucgoias_bronze', 'Nota Bronze PUC-Goiás', 'Atingiu 60+ na PUC-Goiás', '🥉', 'pucgoias', 'score', 60, 100, 2),
('pucgoias_prata', 'Nota Prata PUC-Goiás', 'Atingiu 80+ na PUC-Goiás', '🥈', 'pucgoias', 'score', 80, 200, 5),
('pucgoias_ouro', 'Nota Ouro PUC-Goiás', 'Atingiu 90+ na PUC-Goiás', '🥇', 'pucgoias', 'score', 90, 300, 10),

-- Lições PUC-Goiás
('pucgoias_lessons_5', 'Iniciante PUC-Goiás', 'Completou 5 lições da PUC-Goiás', '📖', 'pucgoias', 'lessons', 5, 50, 1),
('pucgoias_lessons_15', 'Estudante PUC-Goiás', 'Completou 15 lições da PUC-Goiás', '📚', 'pucgoias', 'lessons', 15, 150, 3),
('pucgoias_lessons_20', 'Mestre PUC-Goiás', 'Completou todas as 20 lições PUC-Goiás', '🎓', 'pucgoias', 'lessons', 20, 300, 5);

-- ============================================================================
-- LIÇÕES PUC-Goiás - 20 (5 por critério)
...
('pucgoias', 1, 1, 'A Redação PUC-Goiás', 'Conhecendo o vestibular', 
'# A Redação da PUC-Goiás
...
## Diferencial
Tradição goiana e valores humanísticos.',
'[{"question": "A PUC-Goiás fica em:", "options": ["Brasília", "Goiânia"], "correct": 1}]',
30, 'free', 0),

('pucgoias', 1, 2, 'Interpretando o Tema', 'Compreensão correta', 
'# Análise do Tema
...
('pucgoias', 1, 3, 'Tese Clara', 'Posicionamento objetivo', 
'# Construindo a Tese
...
✅ "O agronegócio goiano demanda práticas sustentáveis que conciliem produtividade e preservação do Cerrado"',
'[{"question": "A tese deve ser:", "options": ["Vaga", "Clara e defensável"], "correct": 1}]',
40, 'previous', 0),

('pucgoias', 1, 4, 'Temas Goianos', 'Contexto PUC-Goiás', 
'# Temas da PUC-Goiás
...
'[{"question": "Cora Coralina era:", "options": ["Pintora", "Poetisa goiana"], "correct": 1}]',
45, 'previous', 0),

('pucgoias', 1, 5, 'Repertório Sociocultural', 'Fontes para argumentar', 
'# Repertório para PUC-Goiás
...
- Bernardo Élis
- José J. Veiga',
'[{"question": "O Cerrado é considerado:", "options": ["Deserto", "Hotspot de biodiversidade"], "correct": 1}]',
50, 'previous', 0);

-- CRITÉRIO 2: ESTRUTURA E COESÃO (5 lições)
INSERT INTO lesson (exam_type, competency, "order", title, description, content, quiz_data, xp_reward, unlock_type, unlock_value) VALUES
('pucgoias', 2, 1, 'Estrutura Dissertativa', 'Organizando o texto', 
...
('pucgoias', 2, 2, 'Introdução Eficaz', 'Abrindo o texto', 
'# A Introdução
...
('pucgoias', 2, 3, 'Coesão Textual', 'Conectando ideias', 
'# Coesão
...
('pucgoias', 2, 4, 'Transições', 'Entre parágrafos', 
'# Transições Fluidas
...
('pucgoias', 2, 5, 'Conclusão', 'Fechando o texto', 
'# A Conclusão
...
INSERT INTO lesson (exam_type, competency, "order", title, description, content, quiz_data, xp_reward, unlock_type, unlock_value) VALUES
('pucgoias', 3, 1, 'Tipos de Argumento', 'Construindo defesas', 
'# Argumentação
...
('pucgoias', 3, 2, 'Análise Crítica', 'Aprofundando', 
'# Análise Crítica
...
('pucgoias', 3, 3, 'Coerência Argumentativa', 'Lógica do texto', 
'# Coerência
...
('pucgoias', 3, 4, 'Progressão', 'Avançando ideias', 
...
('pucgoias', 3, 5, 'Repertório', 'Usando referências', 
'# Repertório
...
INSERT INTO lesson (exam_type, competency, "order", title, description, content, quiz_data, xp_reward, unlock_type, unlock_value) VALUES
('pucgoias', 4, 1, 'Norma Culta', 'Gramática essencial', 
'# Norma Culta
...
('pucgoias', 4, 2, 'Concordância', 'Verbal e nominal', 
'# Concordância
...
('pucgoias', 4, 3, 'Regência e Crase', 'Preposições corretas', 
'# Regência
...
'[{"question": "''Ir a Goiânia'' tem crase?", "options": ["Sim", "Não (cidade sem artigo)"], "correct": 1}]',
40, 'previous', 0),

('pucgoias', 4, 4, 'Pontuação', 'Vírgulas e mais', 
'# Pontuação
...
('pucgoias', 4, 5, 'Revisão Final', 'Checklist', 
'# Checklist PUC-Goiás
...
SELECT 'PUC-Goiás: Criadas conquistas e ' || COUNT(*) || ' lições!' as status FROM lesson WHERE exam_type = 'pucgoias';
